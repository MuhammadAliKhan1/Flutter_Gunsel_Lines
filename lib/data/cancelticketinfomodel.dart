class Cancelticketinfo {
  Data data;

  Cancelticketinfo({this.data});

  Cancelticketinfo.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    penaltyRate = json['PenaltyRate'];
    penalty = json['Penalty'];
    totalCut = json['TotalCut'];
    totalPaidBack = json['TotalPaidBack'];
    ticket =
  ...
  Map<String, dynamic> toJson() {
    ...
    data['TotalCut'] = this.totalCut;
    data['TotalPaidBack'] = this.totalPaidBack;
    if (this.ticket != null) {
...
class Ticket {
  ...
  Ticket.fromJson(Map<String, dynamic> json) {
    ...
    toStation = json['ToStation'] != null
        ? new ToStation.fromJson(json['ToStation'])
        : null;
...
class ToStation {
  ...
  ToStation.fromJson(Map<String, dynamic> json) {
    stationId = json['StationId'];
    stationCategory = json['StationCategory'];
    stationName = json['StationName'];
    stationCode = json['StationCode'];
