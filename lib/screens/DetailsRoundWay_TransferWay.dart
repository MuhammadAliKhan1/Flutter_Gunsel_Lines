...
class DetailRoundWay_TransferWay extends StatefulWidget {
  Map<String, dynamic> ticketData;
  DetailRoundWay_TransferWay({
    @required this.ticketData,
  });

  @override
  _DetailRoundWay_TransferWayState createState() =>
      _DetailRoundWay_TransferWayState();
}

class _DetailRoundWay_TransferWayState
    extends State<DetailRoundWay_TransferWay> {
